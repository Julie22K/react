...
export default class AppTestimony extends Component {

  render() {
    return (
        <div id="testimony" className="container-part">
            <center>
                ...
                <img id="img_centre" src={pers4} alt=""></img>
                <img id="img_topleft" src={pers1} alt=""></img>
                <img id="img_medleft" src={pers2} alt=""></img>
                <img id="img_botleft" src={pers3} alt=""></img>
                <img id="img_topright" src={pers5} alt=""></img>
                <img id="img_medright" src={pers6} alt=""></img>
                <img id="img_botright" src={pers7} alt=""></img>
            </center>
        </div>
    );
  };
